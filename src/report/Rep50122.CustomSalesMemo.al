...
report 50122 "Custom Sales - Memo"
{
    Caption = 'Sales - Credit Memo Custom';
    DefaultRenderingLayout = "StandardSalesCreditMemo.rdlc";
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Src/Layout/StandardSalesCreditMemo.rdl';
