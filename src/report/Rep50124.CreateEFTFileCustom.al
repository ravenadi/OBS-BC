report 50124 "Create EFT File Custom"
{
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            begin
                ...
                // SetRange("Line No.", GenJnlLine."Line No.");
    ...
    // procedure SetGenJnlLine(var NewGLJnlLine: Record "Gen. Journal Line")
    // begin
    //     GenJnlLine.getselectionfilters(NewGLJnlLine);
    ...
    begin
        ...
        BalGenJournalLine.SetRange("Document No.", GenJournalLine."Document No.");
        BalGenJournalLine.SetRange("Posting Date", GenJournalLine."Posting Date");
