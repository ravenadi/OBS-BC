report 60105 "Remittance Advice Test"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'RemittanceAdviceJournals (1).rdl';
    ...
    dataset
    {
        dataitem(FindVendors; "Gen. Journal Line")
        {
            ...
            var
                myInt: Integer;
            begin
                "Gen. Journal Line".copy(FindVendors);
            end;
        ...
        dataitem(VendLoop; "Integer")
        {
            ...
            column(VendAddr1; TempVend.Address)
            {
            }
            // column(VendAddr2; VendorAddr[2])
            column(VendAddr2; TempVend."Address 2")
            {
            }
            ...
            column(VendAddr3; TempVend."Address 3")
            {
            }
            ...
            column(APtelephone; Companyinfo."AP Telephone")
            {
            }
            ...
            column(ACN; CompanyInfo."IRD No.")
            {
            }
            column(NEmail; CompanyInfo."AP E-Mail")
            {
            }
            column(VendorName; TempVend.Name)
            {
            }
            ...
            dataitem("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                column(JGLineNo; "Gen. Journal Line"."Line No.")
                {
                }
                column(JAmount; "Gen. Journal Line".Amount)
                {
                }
                ...
                dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
                {
                    ...
                    column(INV_Amount; "Vendor Ledger Entry".Amount)
                    {
                ...
                dataitem(PrintLoop; "Integer")
                {
                    ...
                    {
                        AutoFormatExpression = TempAppliedVendLedgEntry."Currency Code";
                        AutoFormatType = 1;
                    }
                    ...
                    column(AppliedVendLedgEntryTempInvoiceAmt; -TempAppliedVendLedgEntry."Amount")
                    {
                        AutoFormatExpression = TempAppliedVendLedgEntry."Currency Code";
                        AutoFormatType = 1;
                    }
                    ...
                    begin
                        ...
                        // Modified to skip only if there is no remaining amount to process
                        if (JnlLineRemainingAmount <= 0) and (TempAppliedVendLedgEntry."Remaining Amount" = 0) then
                            CurrReport.Skip();

                        TempAppliedVendLedgEntry.CalcFields("Remaining Amount", "Original Amount", "Amount");
                        ...
                        if TempAppliedVendLedgEntry."Currency Code" <> "Gen. Journal Line"."Currency Code" then begin
                            ...
                            TempAppliedVendLedgEntry."Amount" :=
                              CurrExchRate.ExchangeAmtFCYToFCY(
                                "Gen. Journal Line"."Posting Date",
                                TempAppliedVendLedgEntry."Currency Code",
                                "Gen. Journal Line"."Currency Code",
                                TempAppliedVendLedgEntry."Amount");
                            TempAppliedVendLedgEntry."Amount" := Round(TempAppliedVendLedgEntry."Amount", AmountRoundingPrecision);
                ...
                begin
                    ...
                    "Gen. Journal Line".SetRange("Remmitance Report", true);
                    "Gen. Journal Line".SetRange("Account Type", "Gen. Journal Line"."Account Type"::Vendor);
                    "Gen. Journal Line".SetRange("Account No.", FindVendors."Account No.");
                    if "Gen. Journal Line".FindSet() then;
                    // SetRange("Account No.", TempVend."No.");
                    // SetFilter("Document No.", FindVendors.GetFilter("Document No.")); // SP++: Apply Document No. filter from FindVendors
                    // SetFilter("Source Line No.", FindVendors.GetFilter("Source Line No."))
                end;
            }
    ...
    begin
        ...
        if TempAppliedVendLedgEntry.Insert() then begin
            ...
            TempAppliedVendLedgEntry.CalcFields("Remaining Amt. (LCY)", "Amount");
