...
report 50102 "Sales - Invoice"
{
    ...
    DefaultRenderingLayout = "SalesInvoice.rdlc";
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            { }
            // DCS::HP02122025 ++
            column(BlanketSalesOrderNo_Header; "Blanket Sales Order No.")
            {
            }
            // DCS::HP02122025 --
            column(CustomerPONumber; "Customer PO Number")
            { }
            column(Full_Topic; "Full Topic")
            { }
            column(OBU_code; "Shortcut Dimension 1 Code")
            { }
            ...
            { }
            // DCS::HK 13102025 ++
            column(Work_Description; "D01 Description") { }
            // DCS::HK 13102025 --
            ...
            dataitem(WorkDescriptionLines; "Integer")
            {
                ...
                begin
                    if not ShowWorkDescription then
                        CurrReport.Break();
                    // DCS::HK 13102025 ++
                    Header."D01 Description".CreateInStream(WorkDescriptionInstream, TEXTENCODING::UTF8);
                    // DCS::HK 13102025 --
                end;
            }
            ...
            begin
                ...
                ShowWorkDescription := "D01 Description".HasValue;
                // DCS::HK 13102025 --
    ...
    rendering
    {
        ...
        layout("SalesInvoiceWA.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/PostedSalesInvoiceWA.docx';
            Caption = 'Sales Invoice Word WA';
            Summary = 'The Standard Sales Invoice (Word) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
        layout("SalesInvoiceNSW.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/SalesinvoiceNSW.docx';
            Caption = 'Sales Invoice Word NSW';
            Summary = 'The Standard Sales Invoice (Word) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
        layout("SalesInvoiceQLD.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/SalesInvoiceQLD.docx';
            Caption = 'Sales Invoice Word QLD';
            Summary = 'The Standard Sales Invoice (Word) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
        layout("SalesInvoiceVIC.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/SalesInvoiceVIC.docx';
            Caption = 'Sales Invoice Word VIC';
            Summary = 'The Standard Sales Invoice (Word) provides a simple layout that is also relatively easy for an end-user to modify.';
        }
        layout("StandardSalesInvoiceDefEmail.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/StandardSalesInvoiceDefEmail.docx';
