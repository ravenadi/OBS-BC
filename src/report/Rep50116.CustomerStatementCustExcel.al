...
report 50116 "Customer Statement Cust Excel"
{
    Caption = 'Customer Statement Excel';
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultRenderingLayout = "CustomerStatement RDLC";
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/Layout/CustomerStatement.rdl';
            Caption = 'Customer Statement RDLC';
            Summary = 'The Standard Customer Statement (RDLC) provides a basic layout.';
        }
    }
    ...
    begin
        ...
        AgingDateHeader3 := Format(AgingDate[4] - AgingDate[2] + 1) + ' - ' + Format(EndDate - AgingDate[2]) + ' days';
        AgingDateHeader4 := Format(AgingDate[4] - AgingDate[1] + 1) + ' - ' + Format(EndDate - AgingDate[1]) + ' days';
        AgingDateHeader5 := 'After ' + Format(EndDate - AgingDate[1]) + ' days'
    end;
