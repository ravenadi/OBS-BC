...
report 50103 "Purchase Order Invoice"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            // DCS::HP11112025 ++
            column(SpecialInstruction_PurchaseHeader; "Special Instruction")
            {
            }
            // DCS::HP11112025 --
    ...
    rendering
    {
        ...
        {
            Type = Word;
            LayoutFile = './src/Layout/StandardPurchaseOrder.docx';
        ...
        {
            Type = Word;
            LayoutFile = './src/Layout/StandardPurchaseOrderEmail.docx';
