...
report 50107 "Sales - Pro Forma Inv"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(Customer_PO_Number; "Customer PO Number")
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(JobNo; "Job No.") { }
                column(ShortcutDimensionCode; "Shortcut Dimension 1 Code") { }
    ...
    rendering
    {
        ...
        layout("SalesProFormaInvWA.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/ProformaInvoiceWA.docx';
            Caption = 'Standard Sales Proforma Invoice (Word) WA';
            Summary = 'The Standard Sales Proforma Invoice (Word) provides a basic layout.';
        }
        layout("SalesProFormaInvVIC.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/ProformaInvoiceVIC.docx';
            Caption = 'Standard Sales Proforma Invoice (Word) VIC';
            Summary = 'The Standard Sales Proforma Invoice (Word) provides a basic layout.';
        }
        layout("SalesProFormaInvQLD.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/ProformaInvoiceQLD.docx';
            Caption = 'Standard Sales Proforma Invoice (Word) QLD';
            Summary = 'The Standard Sales Proforma Invoice (Word) provides a basic layout.';
        }
        layout("SalesProFormaInvNSW.docx")
        {
            Type = Word;
            LayoutFile = './src/Layout/ProformainvoiceNSW.docx';
            Caption = 'Standard Sales Proforma Invoice (Word) NSW';
            Summary = 'The Standard Sales Proforma Invoice (Word) provides a basic layout.';
        }
    }
