...
report 50117 "Aged Acc. Receivable Custom"
{
    // DefaultLayout = RDLC;
    // RDLCLayout = './Sales/Reports/AgedAccountsReceivable.rdlc';
    DefaultRenderingLayout = "Aged Acc Receivable RDLC";
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(CustomerPONumber; CustomerPONumber)
                        {
                        ...
                        begin
                            ...
                            NumberOfLines += 1;
                            if AgedCustLedgEntry[2]."Remaining Amount" + AgedCustLedgEntry[3]."Remaining Amount" + AgedCustLedgEntry[4]."Remaining Amount" + AgedCustLedgEntry[5]."Remaining Amount" + AgedCustLedgEntry[6]."Remaining Amount" > 0 then
                                if EndingDate > CustLedgEntryEndingDate."Due Date" then
                                    NoofDays := EndingDate - CustLedgEntryEndingDate."Due Date";
                            Clear(SalesInvHeader);
                            if SalesInvHeader.get(CustLedgEntryEndingDate."Document No.") then
                                CustomerPONumber := SalesInvHeader."Customer PO Number";
                        end;
    ...
    rendering
    {
        layout("Aged Acc Receivable RDLC")
        {
            Type = RDLC;
            LayoutFile = 'src/Layout/AgedAccountsReceivable.rdl';
        }
    }
