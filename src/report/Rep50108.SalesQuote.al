...
report 50108 "Sales - Quote"
{
    Caption = 'Custom Sales - Quote';
    DefaultRenderingLayout = "SalesQuoteWA.docx";
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Src/Layout/StandardSalesQuote.rdl';
        ...
        {
            Type = Word;
            LayoutFile = './Src/Layout/StandardSalesQuote.docx';
            Caption = 'Standard Sales Quote (Word)';
            Summary = 'The Standard Sales Quote (Word) provides a basic layout.';
        }
        layout("SalesQuoteWA.docx")
        {
            Type = Word;
            LayoutFile = './Src/Layout/SalesQuoteWA.docx';
            Caption = 'Standard Sales Quote (Word) WA';
            Summary = 'The Standard Sales Quote (Word) provides a basic layout.';
        }
        layout("SalesQuoteVIC.docx")
        {
            Type = Word;
            LayoutFile = './Src/Layout/SalesQuoteVIC.docx';
            Caption = 'Standard Sales Quote (Word) VIC';
            Summary = 'The Standard Sales Quote (Word) provides a basic layout.';
        }
        layout("SalesQuoteQLD.docx")
        {
            Type = Word;
            LayoutFile = './Src/Layout/SalesQuoteQLD.docx';
            Caption = 'Standard Sales Quote (Word) QLD';
            Summary = 'The Standard Sales Quote (Word) provides a basic layout.';
        }
        layout("SalesQuoteNSW.docx")
        {
            Type = Word;
            LayoutFile = './Src/Layout/SalesQuoteNSW.docx';
            Caption = 'Standard Sales Quote (Word) NSW';
            Summary = 'The Standard Sales Quote (Word) provides a basic layout.';
        }
